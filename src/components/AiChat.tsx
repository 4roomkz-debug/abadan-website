...
export default function AiChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Привет! Я Асем — виртуальный помощник Abadan & Co., работаю на базе DeepSeek. Могу рассказать про наши тренинги, помочь подобрать программу или просто поболтать 😊 Как настроение сегодня?"
    }
  ]);
