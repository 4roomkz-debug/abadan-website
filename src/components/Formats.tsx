            ...
            <div className="glass-card-gold p-8">
              <div className="flex items-start gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <Link
                    href="/schedule"
                    className="inline-flex items-center gap-2 mt-4 px-5 py-2.5 bg-gradient-to-r from-[#F0BB1E] to-[#EBB417] text-[#2D3A3C] font-semibold rounded-lg hover:shadow-lg hover:shadow-[#F0BB1E]/20 transition-all"
                  >
