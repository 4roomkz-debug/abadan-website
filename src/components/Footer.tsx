          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a href="https://abadan.kz" target="_blank" rel="noopener noreferrer" className="text-[#546569] hover:text-[#00767D] transition-colors duration-300 flex items-center gap-3 group">
                    <svg className="w-4 h-4 text-[#7A8B8E] group-hover:text-[#00767D] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
