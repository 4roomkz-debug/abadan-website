...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#F5F7F7]">
      {/* Top accent line */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#00767D]/20 to-transparent"></div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16 mb-16">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <p className="text-[#546569] leading-relaxed max-w-md">
              ...
              <div className="flex flex-wrap gap-3">
                <div className="flex items-center gap-2 px-4 py-2 rounded-lg border border-[#00767D]/15 bg-[#00767D]/[0.03] text-sm">
                  <svg className="w-4 h-4 text-[#00767D]" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-[#546569]">На рынке с 2015</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 rounded-lg border border-[#00767D]/15 bg-[#00767D]/[0.03] text-sm">
                  <svg className="w-4 h-4 text-[#00767D]" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                  </svg>
                  <span className="text-[#546569]">Алматы, Казахстан</span>
                </div>
              </div>
            </div>
            ...
            {/* Contact */}
            <div>
              <h4 className="text-sm font-bold text-[#2D3A3C] mb-6 uppercase tracking-[0.15em]">Контакты</h4>
              <ul className="space-y-4">
                <li>
                  <a href="tel:+77022413388" className="text-[#546569] hover:text-[#00767D] transition-colors duration-300 flex items-center gap-3 group">
                    <svg className="w-4 h-4 text-[#7A8B8E] group-hover:text-[#00767D] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                  <a href="mailto:i.islambek@abadan.kz" className="text-[#546569] hover:text-[#00767D] transition-colors duration-300 flex items-center gap-3 group">
                    <svg className="w-4 h-4 text-[#7A8B8E] group-hover:text-[#00767D] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                  <a href="http://www.abadan.kz" target="_blank" rel="noopener noreferrer" className="text-[#546569] hover:text-[#00767D] transition-colors duration-300 flex items-center gap-3 group">
                    <svg className="w-4 h-4 text-[#7A8B8E] group-hover:text-[#00767D] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Bottom bar */}
          <div className="pt-10 border-t border-[#00767D]/10">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
              <p className="text-[#7A8B8E] text-sm text-center sm:text-left">
              ...
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="w-10 h-10 rounded-xl border border-[#00767D]/15 flex items-center justify-center text-[#7A8B8E] hover:text-[#00767D] hover:border-[#00767D]/30 hover:shadow-[0_0_20px_rgba(0,118,125,0.1)] transition-all duration-300"
                >
