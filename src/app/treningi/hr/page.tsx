...
const hrTrainings = SCHEDULE_DATA.filter((item) =>
  isHRTraining(item.name)
);

const programAreas = [
  {
    title: "Трудовое право",
    desc: "Трудовой кодекс РК, изменения законодательства, трудовые споры",
    category: "labor-law",
    color: "#3B82F6",
    keywords: ["трудов", "кодекс", "медиац", "спор", "консенсус", "согласительн"],
    icon: (
  ...
  },
  {
    ...
    desc: "Рекрутинг, адаптация персонала, онбординг",
    category: "recruitment",
    color: "#10B981",
    keywords: ["рекрутинг", "подбор", "адаптац"],
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Оплата и нормирование",
    desc: "Оплата труда, нормирование, суммированный учёт, вахтовый метод",
    category: "compensation",
    color: "#F59E0B",
    keywords: ["оплат", "нормирован", "суммирован", "вахт"],
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Оценка компетенций, аттестация, ИПР, оргструктура",
    category: "assessment",
    color: "#8B5CF6",
    keywords: ["оценк", "компетенц", "ИПР", "индивидуальн", "оргструктур", "аттестац"],
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "KPI, грейдирование, мотивация, управление результативностью",
    category: "performance",
    color: "#EF4444",
    keywords: ["результативн", "KPI", "грейд", "мотивац", "эффективн"],
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Развитие лидерства, коучинг, наставничество",
    category: "development",
    color: "#06B6D4",
    keywords: ["лидер", "коучинг", "наставнич", "развити"],
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function getTrainingsByCategory(category: string): typeof hrTrainings {
  const area = programAreas.find((a) => a.category === category);
  if (!area) return hrTrainings;
  return hrTrainings.filter((t) => {
...
const TREND_KEYWORDS = ["ИИ", "искусственн", "AI", "цифров", "автоматизац", "data", "аналитик", "HR Tech"];
...
const testimonials = [
  {
    quote: "Курсы по трудовому законодательству помогли нашей HR-команде избежать судебных рисков. За год — ноль трудовых споров, проигранных компанией",
  ...
  {
    quote: "Программа оценки и развития персонала позволила выстроить систему грейдов и ИПР для 500+ сотрудников. Текучесть снизилась на 35%",
    name: "Алия Мусаева",
  ...
  {
    quote: "Практикум по рекрутингу изменил подход наших HR-менеджеров. Время закрытия вакансий сократилось вдвое, качество найма выросло",
...
/* ── Client logos — HR companies with real images ── */

const HR_CLIENT_LOGOS = [
      ...
      <div className="relative z-10">
        <div className="text-center mb-10 px-4">
          ...
          <p className="text-[#546569] max-w-2xl mx-auto text-lg scroll-fade-in scroll-delay-2">
            Крупнейшие компании Казахстана доверяют нам обучение HR-команд
          </p>
        </div>
        ...
        <div className="overflow-hidden mb-12">
          <motion.div
            ...
            animate={{ x: [0, -156 * HR_CLIENT_LOGOS.length] }}
        ...
        <div className="grid grid-cols-3 gap-3 md:gap-8 max-w-3xl mx-auto text-center px-4">
          <div className="p-3 md:p-6 rounded-2xl bg-white shadow-sm border border-[#00767D]/10 scroll-fade-in">
            <div className="text-2xl sm:text-3xl md:text-5xl font-bold text-[#00767D] mb-1 md:mb-2">20+</div>
...
const FAQ_ITEMS = [
  ...
  { question: "Проводите ли вы корпоративное HR-обучение?", answer: "Да, мы проводим корпоративные тренинги с адаптацией под специфику компании. Выезжаем в регионы Казахстана. Более 50 000 специалистов обучено с 2015 года." },
];
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            <nav className="flex items-center gap-2 text-sm text-[#7A9EA3] mb-8 scroll-fade-in">
              ...
              <span>/</span>
              <span className="text-[#F0BB1E]">HR и кадры</span>
            </nav>
            ...
            <p className="text-lg sm:text-xl text-[#D4E4E7] mb-10 max-w-2xl scroll-fade-in scroll-delay-2">
              От трудового права до HR-аналитики — практические курсы для HR-директоров, кадровиков и руководителей
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12 scroll-fade-in">
              ...
              <p className="text-lg text-[#3d5153]">
                {filteredTrainings.length} курсов {activeCategory ? "в выбранной категории" : "по HR-тематике"}
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-20">
              {[
                {
                  value: "↓ 35%",
                  label: "снижение текучести",
                  desc: "после внедрения системы оценки",
                  caseStudy: "Разработали систему грейдов и ИПР для производственной компании в Караганде. 500+ сотрудников прошли оценку компетенций. За год текучесть персонала снизилась с 28% до 18%.",
                  icon: (
                ...
                {
                  value: "×2",
                  label: "скорость закрытия вакансий",
                  desc: "после тренинга по рекрутингу",
                  caseStudy: "Провели интенсив для HR-команды логистической компании из 12 рекрутеров. Внедрили воронку найма и скрипты интервью. Среднее время закрытия вакансии сократилось с 45 до 22 дней.",
                  icon: (
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                    </svg>
                ...
                {
                  value: "0",
                  label: "проигранных трудовых споров",
                  desc: "после курса по трудовому кодексу",
                  caseStudy: "Обучили юристов и HR-менеджеров нефтесервисной компании (80 человек). За следующий год все 12 трудовых споров были урегулированы досудебно или выиграны работодателем.",
                  icon: (
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
