...
export default function AtyrauPage() {
    ...
    <>
      ...
      <main>
        ...
        <section className="bg-gradient-to-br from-[#1a2e30] via-[#0d2628] to-[#0a1f21] relative overflow-hidden">
          {/* Ambient glows */}
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#00767D]/10 rounded-full blur-[120px] pointer-events-none" />
          <div className="absolute bottom-0 right-1/4 w-72 h-72 bg-[#F0BB1E]/8 rounded-full blur-[100px] pointer-events-none" />
          ...
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20">
            ...
            <nav className="flex items-center gap-2 text-sm text-[#7A8B8E] mb-8 scroll-fade-in">
              ...
              <span>/</span>
              <span className="text-[#F0BB1E]">Атырау</span>
            </nav>
            ...
            <div className="inline-flex items-center gap-2 bg-[#F0BB1E]/15 border border-[#F0BB1E]/30 rounded-full px-4 py-1.5 mb-6 scroll-fade-in scroll-delay-1">
              ...
              <span className="text-[#F0BB1E] text-sm font-600">Выезд на объект — все курсы доступны в Атырау</span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-800 text-white leading-tight mb-6 scroll-fade-in scroll-delay-2">
              ...
              <span className="text-gradient-primary">в Атырау</span>
            </h1>

            <p className="text-lg sm:text-xl text-[#7A8B8E] max-w-2xl mb-10 scroll-fade-in scroll-delay-3">
              Программы повышения квалификации для специалистов ТШО, НКОК и других крупнейших
              операторов Атырауской области. Очный формат, выезд на объект, корпоративное обучение.
            </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl sm:text-4xl font-800 text-[#2D3A3C] mb-6 scroll-fade-in">
                  Атырау — нефтяная столица Казахстана
                </h2>
                <p className="text-[#546569] leading-relaxed mb-4 scroll-fade-in scroll-delay-1">
                  Атырауская область обеспечивает более 40% всей нефтедобычи Казахстана.
                  Здесь сосредоточены крупнейшие нефтегазовые проекты страны: месторождение
                  Тенгиз (ТШО/Tengizchevroil), проект Кашаган (НКОК) и инфраструктура КазМунайГаз.
                </p>
                <p className="text-[#546569] leading-relaxed mb-4 scroll-fade-in scroll-delay-2">
                  Для работы на этих объектах специалисты обязаны постоянно повышать квалификацию:
                  требования операторов и международных стандартов ежегодно ужесточаются.
                  Abadan&nbsp;&amp;&nbsp;Co. сопровождает нефтяников Атырау с момента основания компании.
                </p>
                <p className="text-[#546569] leading-relaxed scroll-fade-in scroll-delay-3">
                  Наши тренеры — практики с опытом в ТШО, НКОК, КазМунайГаз. Они знают
                  местную специфику: нормативы, оборудование, регуляторную среду Атырауской области.
                </p>
              </div>

              <div className="grid grid-cols-2 gap-4 scroll-fade-in scroll-delay-2">
                {[
                  { name: "Tengizchevroil (ТШО)", desc: "Крупнейшее нефтяное месторождение СНГ", color: "#00767D" },
                  { name: "НКОК", desc: "Северо-Каспийский операционный консорциум", color: "#F0BB1E" },
                  { name: "КазМунайГаз", desc: "Национальная нефтегазовая компания РК", color: "#00767D" },
                  { name: "АНПЗ", desc: "Атырауский нефтеперерабатывающий завод", color: "#F0BB1E" },
                ].map((company) => (
                  <div
                    key={company.name}
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-white font-700 text-lg">Выезд на объект — Атырауская область</div>
                  <div className="text-white/80 text-sm">Тренер приезжает к вам: на завод, базу, месторождение</div>
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-800 text-[#2D3A3C] mb-4 scroll-fade-in">
                Все нефтегазовые курсы — доступны в Атырау
              </h2>
              <p className="text-[#546569] max-w-xl mx-auto scroll-fade-in scroll-delay-1">
                Любой курс из расписания можно организовать с выездом тренера в Атырау или онлайн.
              </p>
            </div>
        ...
        <section className="section-white py-20">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl sm:text-4xl font-800 text-[#2D3A3C] mb-4 scroll-fade-in">
                Почему нас выбирают нефтяники Атырау
              </h2>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  icon: "🏭",
                  title: "Знаем специфику региона",
                  desc: "Наши эксперты работали на объектах Тенгиза и Кашагана. Программы учитывают местные стандарты и требования операторов.",
                },
                {
                  icon: "🚗",
                  title: "Приедем к вам",
                  desc: "Организуем обучение прямо на вашем предприятии в Атырау или на производственном объекте — без отрыва сотрудников от работы.",
                },
                {
                  icon: "📋",
                  title: "Соответствие требованиям",
                  desc: "Программы соответствуют требованиям РК по промышленной безопасности и стандартам международных операторов.",
                },
                {
                  icon: "👥",
                  title: "Корпоративные группы",
                  desc: "Обучаем группы от 5 до 50 человек. Разрабатываем кастомные программы под задачи конкретного предприятия.",
                },
                {
                  icon: "📜",
                  title: "Официальные сертификаты",
                  desc: "По итогам обучения выдаём сертификат о повышении квалификации, признаваемый крупными операторами Казахстана.",
                },
                {
                  icon: "⚡",
                  title: "Быстрая организация",
                  desc: "От запроса до старта обучения — от 5 рабочих дней. Экстренное обучение перед инспекцией или аудитом — по согласованию.",
                },
              ].map((item) => (
                <div
                  key={item.title}
        ...
        <section className="bg-[#F8FAFA] py-20">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl sm:text-4xl font-800 text-[#2D3A3C] mb-10 text-center scroll-fade-in">
              Вопросы об обучении в Атырау
            </h2>
            <div className="space-y-3">
              {ATYRAU_FAQ.map((faq, i) => (
                <details
                  key={i}
        ...
        <section id="cta" className="bg-gradient-to-br from-[#1a2e30] via-[#0d2628] to-[#0a1f21] py-20 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-80 h-80 bg-[#F0BB1E]/8 rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-72 h-72 bg-[#00767D]/10 rounded-full blur-[120px] pointer-events-none" />
          <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-800 text-white mb-4 scroll-fade-in">
              Запросить корпоративное обучение в Атырау
            </h2>
            <p className="text-[#7A8B8E] mb-8 scroll-fade-in scroll-delay-1">
              Расскажите о задаче — подберём программу, согласуем даты и организуем выезд тренера.
