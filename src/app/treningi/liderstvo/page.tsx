        ...
        {status === "success" ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <input name="name" type="text" placeholder="Ваше имя" required className="w-full px-4 py-3 bg-white/15 border border-white/20 rounded-xl text-white placeholder:text-[#6B9196] focus:outline-none focus:border-[#00767D] focus:bg-white/20 transition-all text-sm" />
              <input name="phone" type="tel" placeholder="Телефон" required className="w-full px-4 py-3 bg-white/15 border border-white/20 rounded-xl text-white placeholder:text-[#6B9196] focus:outline-none focus:border-[#00767D] focus:bg-white/20 transition-all text-sm" />
              <input name="company" type="text" placeholder="Компания (необязательно)" className="w-full px-4 py-3 bg-white/15 border border-white/20 rounded-xl text-white placeholder:text-[#6B9196] focus:outline-none focus:border-[#00767D] focus:bg-white/20 transition-all text-sm" />
    ...
    <div className="min-h-screen bg-white">
      ...
      <section ref={heroRef} className="relative pt-24 pb-16 sm:pt-32 sm:pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source src="/videos/liderstvo-hero.mp4" type="video/mp4" />
          </video>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 scroll-fade-in scroll-delay-1">
                <div className="grid sm:grid-cols-2 gap-4">
                  <input
                    ...
                    required
                    className="w-full px-5 py-4 bg-white/15 border border-white/20 rounded-xl text-white placeholder:text-[#6B9196] focus:outline-none focus:border-[#00767D] focus:bg-white/20 transition-all"
                  />
                  <input
                    name="phone"
                    type="tel"
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <select
                    name="direction"
                    className="w-full px-5 py-4 bg-white/15 border border-white/20 rounded-xl text-white focus:outline-none focus:border-[#00767D] focus:bg-white/20 transition-all appearance-none"
                    defaultValue=""
                  >
