...
const faqs = [
  {
    ...
    a: "Да. ibirAi разработан с учётом специфики вахтового режима: урок открывается в любое время суток с личного телефона — в лагере, общежитии или на межсменке, а расписание адаптируется под сменный график: утренние или вечерние смены.",
  },
  {
  ...
  {
    q: "На объект телефон проносить нельзя. Как тогда обучать?",
    a: "Так и задумано: обучение идёт вне производственной зоны — в вахтовом лагере, общежитии, автобусе за периметром, дома. Урок открывается по ссылке в Telegram, напоминание дублируется в WhatsApp — оба работают с личного телефона, вне корпоративного контура и без установки приложения. Если внутренняя политика закрывает и это, разберём варианты под ваш контур на созвоне.",
  },
];
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-white/60 mb-10 leading-relaxed scroll-fade-in scroll-delay-2">
                AI-микрообучение для нефтяников, вахтовиков и специалистов ОПО. HSE, промышленная безопасность, сертификация — в мессенджере, вне производственной зоны и в сменном режиме.
              </p>
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="scroll-fade-in-left space-y-4">
                ...
                {[
                  {
                    title: "Телефон нельзя проносить на объект",
                    desc: "На производственной территории личных телефонов быть не должно, а автобус идёт на объект без промежуточной точки сдачи. Обучение «у станка» здесь не работает в принципе.",
                  },
                  {
              ...
              <div className="scroll-fade-in-right space-y-4">
                ...
                {[
                  {
                    title: "Обучение вне производственной зоны",
                    desc: "Урок открывается с личного телефона там, где он разрешён: в вахтовом лагере, общежитии, автобусе за периметром. Устанавливать нечего — ссылка в Telegram, напоминание в WhatsApp.",
                  },
                  {
