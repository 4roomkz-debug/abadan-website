...
export const metadata: Metadata = {
  ...
  description:
    "ibirAi решает задачи обучения в нефтегазовой отрасли: HSE, промышленная безопасность, сертификация H2S, адаптация вахтовиков. Офлайн-режим, сменный график, подтверждённая компетентность каждого работника.",
  keywords: [
