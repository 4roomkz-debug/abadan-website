...
export const metadata: Metadata = {
  ...
  description:
    "ibirAi решает задачи обучения в нефтегазовой отрасли: HSE, промышленная безопасность, сертификация H2S, адаптация вахтовиков. Обучение вне производственной зоны, сменный график, подтверждённая компетентность каждого работника.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "HSE, промышленная безопасность, сертификация — AI-микрообучение для нефтегазовой отрасли. Обучение вне производственной зоны, сменный график.",
...
export default function IbiraiNeftegazLayout({
  ...
  const softwareJsonLd = {
    ...
    description:
      "AI-платформа микрообучения для нефтегазовой отрасли: HSE, промышленная безопасность, технические компетенции, сертификация. Обучение вне производственной зоны и адаптация под сменный график.",
    offers: {
      "@type": "Offer",
      price: "0",
      priceCurrency: "KZT",
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Да. ibirAi разработан с учётом специфики вахтового режима: урок открывается в любое время суток с личного телефона — в лагере, общежитии или на межсменке, а расписание адаптируется под сменный график.",
        },
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        name: "На объект телефон проносить нельзя. Как тогда обучать?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Обучение идёт вне производственной зоны — в вахтовом лагере, общежитии, автобусе за периметром, дома. Урок открывается по ссылке в Telegram, напоминание дублируется в WhatsApp — оба работают с личного телефона, вне корпоративного контура и без установки приложения.",
        },
      },
    ],
  };
