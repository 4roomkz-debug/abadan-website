...
const faqs = [
  ...
  },
  {
    ...
    a: "Первые измеримые результаты появляются через 4–6 недель ежедневных 10-минутных практик. Полноценное закрепление навыка требует 90 дней — именно такой горизонт рекомендуется для программ командного развития.",
  },
  {
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-lg md:text-xl text-white/60 mb-10 leading-relaxed scroll-fade-in scroll-delay-2">
                ibirAi развивает коммуникацию, лидерство и эмоциональный интеллект через ежедневные 10-минутные диалоговые симуляции в Telegram. Без отрыва от работы, без новых приложений.
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  desc: "Урок на 10 минут открывается в Telegram в удобное для сотрудника время, напоминание дублируется в WhatsApp. Ответы на симуляцию — прямо в чате, без перехода в другие приложения.",
                  icon: (
                    <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {[
                ...
                { value: "80%+", label: "дошли до финала", note: "кейс Santo, 117 руководителей" },
              ].map((m, i) => (
                <div
                  key={m.label}
