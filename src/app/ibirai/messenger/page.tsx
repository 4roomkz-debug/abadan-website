...
const faqs = [
  ...
  },
  {
    ...
    a: "Нет. Урок открывается в Telegram — в мини-приложении внутри мессенджера, который уже установлен у большинства сотрудников. Достаточно запустить бот. Напоминание приходит ещё и в WhatsApp и ведёт обратно в Telegram. Никаких логинов, паролей и новых интерфейсов.",
  },
  {
    q: "Как обеспечивается безопасность корпоративного контента в мессенджерах?",
    a: "Передача идёт через зашифрованные API мессенджеров, работа с корпоративным контентом — под NDA. Данные хранятся в защищённой инфраструктуре с шифрованием. Для госкомпаний и квазигоса возможна on-premise-опция: контур обсуждаем под требования вашей службы ИБ.",
  },
  {
  ...
  {
    q: "У нас на площадке мессенджеры ограничены. Что тогда?",
    a: "Урок открывается по ссылке в Telegram, напоминание дублируется в WhatsApp — оба работают с личного телефона, вне корпоративного контура и без установки приложения. Если внутренняя политика закрывает и это, скажите на созвоне — разберём варианты под ваш контур. Заранее обещать интеграцию не будем.",
  },
];
...
const platforms = [
  ...
  },
  {
    ...
    features: [
      ...
      "Напоминание о новом уроке со ссылкой в Telegram",
      "Догоняет тех, кто не открыл Telegram",
      "Не требует от сотрудника ничего устанавливать",
    ],
    badge: "Канал напоминаний",
  },
  {
    name: "Веб-версия",
    ...
    features: [
      ...
      "Поимённо: кто прошёл, кто понял, кто в зоне риска",
      "Расширенная аналитика и отчёты",
      "Управление контентом и курсами",
      "Экспорт отчётов для аудита",
    ],
    badge: "Для HR",
  },
];
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl text-white/60 mb-10 leading-relaxed scroll-fade-in scroll-delay-2">
                  ibirAi доставляет уроки в Telegram, а напоминание дублирует в WhatsApp. Никаких новых приложений, никаких забытых паролей — обучение там, где люди уже проводят время.
                </p>
                ...
                {[
                  {
                    num: "01",
                    title: "Подключение",
                    desc: "Заключаем договор, настраиваем Telegram-бот под ваш корпоративный стиль и подключаем WhatsApp-напоминания.",
                    time: "1–3 дня",
                    icon: (
