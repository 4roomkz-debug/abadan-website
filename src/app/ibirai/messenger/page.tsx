...
const faqs = [
  {
    ...
    a: "Мессенджеры открывают в 4 раза чаще, чем письма LMS: 87% vs 23%. Сотрудник не заходит в отдельное приложение — урок приходит туда, где он уже находится. Это снимает главный барьер корпоративного обучения — «зайти и открыть».",
  },
  {
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div className="scroll-fade-in-right grid grid-cols-2 gap-4">
                {[
                  { value: "87%", label: "открываемость", sub: "сообщений в мессенджерах" },
                  { value: "23%", label: "открываемость", sub: "у традиционных LMS" },
              ...
              {[
                {
                  ...
                  desc: "87% открываемости сообщений в Telegram vs 23% у email-рассылок LMS. Урок не теряется в почте — он приходит туда, куда заглядывают каждый час.",
                  color: "teal",
                },
                {
                  value: "0",
