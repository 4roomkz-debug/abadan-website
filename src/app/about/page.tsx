...
export default function AboutPage() {
  ...
  const hybridFormats = [
    ...
    },
    {
      ...
      description: "Короткие уроки в Telegram с проверкой усвоения, напоминание — в WhatsApp. Флагманский кейс — Polpharma Santo: 117 руководителей, 80%+ дошли до финала.",
      icon: (
        <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
